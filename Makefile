...
release: $(CLIENT_DEPEND)
	$(CC) $(CFLAGS_OPTIMIZED) -o $(CLIENT_TARGET) client.cpp game.cpp gametest.cpp client.res $(CLIENT_LIBS)

client: $(CLIENT_DEPEND)
	$(CC) $(CFLAGS_DEBUGGING) -o $(CLIENT_TARGET) client.cpp game.cpp gametest.cpp $(CLIENT_LIBS)
...
#	$(CC) $(CFLAGS_DEBUGGING) -D DEBUG -o $(SERVER_TARGET) server.cpp $(SERVER_LIBS)
	$(CC) $(CFLAGS_DEBUGGING) -D DEBUG -o $(CLIENT_TARGET) client.cpp game.cpp gametest.cpp $(CLIENT_LIBS)
